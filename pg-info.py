...
class PgInfo:
    ...
    def printDBSize(self):
        ...
        fmt = [('schema', 32), ('*total_sz', 11), ('data_sz', 11),
               ('index_sz', 11), ('index_sz%', 9, "%.0f%%")]
    ...
    def printTablesSize(self):
        ...
        fmt = [('table', 32),
               ('total_bytes', 0),
               ('*total_sz', 11), ('data_sz', 11), ('index_sz',
                                                    11), ('index_sz%', 9, "%d%%"),
    ...
    def printDeadIndexes(self):
        self._printHeader(
            "Less frequently accessed indexes ordered by IDX_SIZE")
        q = """
		SELECT
...
def main():
    ...
    p.add_option("-s", "--sql",     action="store_true",
                 help="print SQLs that were used to obtain the stats")
    p.add_option("-l", "--lines",   type=int, default=20,
                 help="num of lines in output (default %default)")
